...
ggsave(filename = "figures/lineups/sa3_ns_geo.png", plot = sa3_ns_geo, dpi=300, device = "png", width = 12, height = 6)
...
sa3_ns_hex <- ggplot() + 
  ...
  scale_fill_distiller(type = "div", palette = "Spectral") + 
  facet_wrap(~ simulation) + theme_minimal()
ggsave(filename = "figures/lineups/sa3_ns_hex.png", plot = sa3_ns_hex, dpi=300, device = "png", width = 12, height = 6)
